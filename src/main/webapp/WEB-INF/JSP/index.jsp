    ...
    <c:forEach items="${articleList}" var="ArticleIntroduct">
      <div class="blogs">
        <ul>
          ...
          <p class="autor"><span class="lm f_l"><a href="/">个人博客</a></span><span class="dtime f_l">${ArticleIntroduct.faTime}</span><span class="viewnum f_r">浏览（<a href="/">${ArticleIntroduct.faEye}</a>）</span><span class="pingl f_r">评论（<a href="/">${ArticleIntroduct.addLikeCount}</a>）</span></p>
        </ul>
      </div>
      </c:forEach>
    </div>
